                ...
                <form action="{{ route('import.dosen.store') }}" method="POST" class="grid md:grid-cols-3 gap-8" enctype="multipart/form-data">{{-- <form wire:submit.prevent="import" class="grid md:grid-cols-2 gap-8" enctype="multipart/form-data"> --}}
                    ...
                    <div class="space-y-2 col-span-2">
                        <div class="text-left">
                            ...
                            <x-atom.button-with-google-icon href="{{ asset('keperluan_import/dosen_import.xlsx') }}" :icon="'download'" class="bg-gray-100 shadow-sm text-gray-500  inline-flex p-2 rounded cursor-pointer   hover:shadow-md  hover:text-gray-600">
                                template.xlsx
                            </x-atom.button-with-google-icon>
                        </div>
