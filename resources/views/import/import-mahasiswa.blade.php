    ...
    <div>
        ...
        <div id="atas" class="container mx-auto bg-gray-100 mb-28">
            ...
            <div class="flex justify-between items-center mt-6">
                ...
                <x-atom.button-with-google-icon href="{{ route('mahasiswa') }}" :icon="'arrow_back'"
            ...
            <div class="bg-white rounded shadow-md p-2 my-3">
                <form action="{{ route('import.mahasiswa.store') }}" method="POST" class="grid md:grid-cols-3 gap-8" enctype="multipart/form-data">{{-- <form wire:submit.prevent="import" class="grid md:grid-cols-2 gap-8" enctype="multipart/form-data"> --}}
                    @csrf
                    <div class="space-y-2">
                        
                        <div class="text-left space-y-1">
                            <label class="f-roboto ml-1 text-gray-500 text-sm block">Upload template (.xlsx)</label>
                            <input type="file" name="mahasiswabaru" class="shadow text-sm border-none p-2 w-full rounded focus:outline-none focus:ring-2 focus:ring-blue-300 placeholder-gray-300">
                            @error('mahasiswabaru') <span class="error">{{ $message }}</span> @enderror
                        </div>
                    ...
                    <div class="space-y-2 col-span-2">
                        <div class="text-left">
                            ...
                            <x-atom.button-with-google-icon href="{{ asset('_keperluan_import/mahasiswa_import.xlsx') }}" :icon="'download'" class="bg-gray-100 shadow-sm text-gray-500  inline-flex p-2 rounded cursor-pointer   hover:shadow-md  hover:text-gray-600">
                                template.xlsx
                            </x-atom.button-with-google-icon>
                        </div>
