...
<div class="w-full overflow-x-hidden border-t flex flex-col container mx-auto bg-gray-100 mb-28">
    <main class="w-full flex-grow p-6">
        ...
        <h1 class="text-3xl text-black pb-4">Tambah Ruangan</h1>
            ...
            <div class="bg-white overflow-auto mb-6 py-3 px-6 rounded">
                ...
                <div class="flex border-b border-40">
                    ...
                    <div class="w-3/4 py-4 break-words">
                        <x-atom.form-input-standar wire:model="ru.nama" placeholder="nama"/>
                        <x-atom.form-error-input :kolom="'ru.nama'" />
                    </div>
                </div>

                <div class="flex border-b border-40">
                    <div class="w-1/4 py-4">
                        <h4 class="font-normal text-80">Kapasitas</h4>
                    </div> 
                    <div class="w-3/4 py-4 break-words">
                        <x-atom.form-input-standar wire:model="ru.kapasitas" placeholder="kapasitas" type="number"/>
                        <x-atom.form-error-input :kolom="'ru.kapasitas'" />
                    </div>
                </div>
                ...
                <div class="flex border-b border-40">
                    ...
                    <div class="w-3/4 py-4 break-words">
                        <x-atom.form-select-standar wire:model="ru.kategori">
                        ...
                        <x-atom.form-error-input :kolom="'ru.kategori'" />
                    </div>
                </div>
